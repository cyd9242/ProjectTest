...
<link href="<c:url value="/resources/css/fontStyle.css" />" rel="stylesheet">
	...
	<div id="wrapper">
		...
		<section id="banner" class="style2">
			<div class="inner">
				...
				<header class="major">
					<div align = "center">
						<h1 style = "color:white;">가상 홈페이지: 로그인</h1>
					</div>
				</header>
			</div>
		</section>
		...
		<div id="main">
			...
			<section id="one">
				<div class="inner">
					<header>
						<div align = "center" class = "loginDivStyle" id = "loginDiv">
						<br/><br/>
						...
						<form action="${loginUrl}" method="post" onsubmit="return checkResult()">
							...
							<c:if test="${param.fail !=null}">
									<label class = "loginErrorlabel">로그인 실패했습니다!!!</label><br/>
							</c:if>						
							<a href = "/virtualHomePage/idFind" rel="noopener" target="_blank" class = "a"><label class = "loginAnchorLabel">아이디 찾기</label></a>
							<label class = "loginAnchorLabel1"> | </label>
							<a href = "/virtualHomePage/PasswordFind" rel="noopener" target="_blank" class = "a"><label class = "loginAnchorLabel">비밀번호 찾기</label></a>
							<label class = "loginAnchorLabel1"> | </label>
							<a href = "/virtualHomePage/signUp" rel="noopener" target="_blank" class = "a"><label class = "loginAnchorLabel">회원가입</label></a>
						</form>
					</div>
					</header>
				</div>
