...
<body class="is-preload" name = "top">
	...
	<div id="wrapper">
		...
		<section id="banner" class="style2">
			<div class="inner">
				...
				<header class="major">
					<div align = "center">
						<h1 style = "color:white;">가상 홈페이지 회원가입</h1>
					</div>
				</header>
			</div>
		</section>
		...
		<div id="main">
			...
			<section id="one">
				<div class="inner">
					<header>
						<div class = "signUpFormDivStyle" align = "center">
							<br/><br/>
							<table border = "1" cellpadding = "0" cellspacing = "0" class = "signUpTableStyle" style = "position:relative; left:25px;">
								<form:form action = "/signUpOk" commandName="VVO" method = "post" onsubmit="return checkResult()">
									<tbody>
										<tr>
											<th align = "center">아이디</th>
											<td colspan = "2">
												<input type = "hidden" id = "idchk" >
												<form:input path = "vId" id = "vId" placeholder = " 아이디" maxlength = "10" size = "25" style = "position:relative; left:15px; border:none; background:transparent; width:85%; padding:7px;"/>
											</td>
											<td colspan = "1">
												<button type = "button" class = "idCheckbutton" onClick = "idCheck(this.form.vId.value)">아이디 확인</button>						
											</td>
										...
										<tr>
										 ...
										 <tr>
											<th align = "center" style = "border-bottom-left-radius:0px;">비밀번호</th>
											<td colspan = "3">
												<form:password path = "vPwd" id = "vPwd" placeholder = " 비밀번호" maxlength = "20" size = "26" style = "position:relative; left:15px; border:none; background:transparent; width:85%; padding:7px;"/>
											</td>
										</tr>
										<tr>
											<th align = "center" style = "border-top-left-radius:0px;">비밀번호 확인</th>
											<td colspan = "3">
												<form:password path = "vPwdRe" id = "vPwdRe" placeholder = " 비밀번호 확인" maxlength = "20" size = "26" style = "position:relative; left:15px; border:none; background:transparent; width:85%; padding:7px;"/>
											</td>
										</tr>
										<tr>
											<th style = "background:none"></th>
											<td colspan = "3" align = "right" style = "padding:7px;">
										...
										<tr>
											...
											<td colspan = "2">
												<input type = "hidden" id = "NickNameChk" >
												<form:input path = "vNickName" id = "vNickName" placeholder = " 닉네임" maxlength = "10" size = "25" style = "position:relative; left:15px; border:none; background:transparent; width:85%; padding:7px;"/>
											</td>
											<td colspan = "1">
												<button type = "button" class = "NickNameCheckbutton" onClick = "NickNameCheck(this.form.vNickName.value)">닉네임 확인</button>						
											</td>
										...
										<tr>
											...
											<td colspan = "3">
												<form:input path = "vName" placeholder = " 이름" maxlength = "20" size = "25" style = "position:relative; left:15px; border:none; background:transparent; width:85%; padding:7px;"/>
										...
										<tr align = "center">
											...
											<td align = "center">
												<form:select align = "center" path="vBirth1" id = "vBirth1" >
										...
										<tr align = "center">
											<th style = "padding:7px;">성별</th>											
											<td align = "center" colspan = "3">
												<label>남성(M)</label>
												<form:radiobutton path = "vGender" value = "남성" id = "vGender"/>&nbsp;&nbsp;&nbsp;
												<label>여성(W)</label>
												<form:radiobutton path = "vGender" value = "여성" id = "vGender"/>
											</td>
										...
										<tr>
											...
											<td colspan = "2"> 
												<form:input path = "vEmail" id = "vEmail" placeholder = " Email" maxlength = "30" size = "25" style = "position:relative; left:15px; border:none; background:transparent; width:85%; padding:7px;"/>
											</td>
											<td colspan = "1">
										...
										<tr>
											...
											<td colspan = "3" align = "right">
												<input type = "text" readOnly = "readOnly" id = "checkRe" disabled = "" style = "border:none; width:95%; background:none; color:red; font-size:15px;"><br/><br/>
											</td>
										</tr>
										...
										<tr align = "center">
											...
											<td style = "padding:7px;" align = "center" colspan = "3">
												...
												<form:input path = "vTel2" id = "vTel2" maxlength = "4" style = "border:none; background:none; width:20%; text-align: center;"/>&nbsp;<label>-</label>    
										...
										<tr>
											...
											<td colspan = "2" style = "padding:7px;">
												<form:input path = "vPostCode" id = "vPostCode" placeholder = " 우편번호" readOnly= "readOnly" style = "border:none; background:transparent; width:100%;"/>
											</td>
											<td colspan = "1">
												<button type = "button" onClick = "execPostCode()" class = "postCodebutton">우편번호<br/>검색</button>
											</td>
										</tr>
										<tr>
											<th style = "background:none;"></th>
											<td colspan = "3" style = "padding:7px;">
												<form:input path = "vAddress1" id = "vAddress1" placeholder = " 도로명 주소"  readOnly= "readOnly" style = "border:none; background:transparent; width:100%;"/>
											<td>
										</tr>
										<tr>
											<th style = "background:none;"></th>
											<td colspan = "3" style = "padding:7px;">
												<form:input path = "vAddress2" id = "vAddress2" placeholder = " 상세주소" style = "border:none; background:transparent; width:100%;"/>
											</td>
										</tr>
										<tr>
											<th style = "background:none;">
										...
										<tr align = "center" >
											<th style = "padding:7px;" >권한</th>
											<td align = "center" colspan = "3">
												<label>유저</label>
												<form:radiobutton path = "role_name" id = "role_name" value = "ROLE_USER"/>&nbsp;&nbsp;
												<label>관리자</label>
												<form:radiobutton path = "role_name" id = "role_name" value = "ROLE_ADMIN"/>
											</td>
										</tr>
										<tr>
											<th style = "background:none;">
	...
	<!-- Scripts -->
			...
			<script src='<c:url value="/resources/js/NickNameCheck.js"/>'></script>
			<script src='<c:url value="/resources/js/telFocus.js"/>'></script>
			<script src='<c:url value="/resources/js/signUpEmail.js"/>'></script>
