	...
	<div id="wrapper">
		...
		<section id="banner" class="style2">
			<div class="inner">
				<header class="major">
					<div align = "center">
						<h1 style = "color:white;">비밀번호 찾기</h1>
					</div>
				</header>
			</div>
		</section>
			...
			<section class="split">
				<section>
					<div class="contact-method">
						<div align = "center">
							<div class = "passwordFindFormDivStyle">
								<a href = "/virtualHomePage/PasswordFind/EmailPasswordFind"><button class = "EandTbutton"><img src = "/resources/image/E.png" class = "EandTImageStyle"/>&nbsp;가입한 이메일로 비밀번호 찾기</button></a>
							</div>
						</div>
					</div>
				</section>
				<section>
					<div class="contact-method">
						<div align = "center">
							<div class = "passwordFindFormDivStyle">
								<a href = "/virtualHomePage/PasswordFind/TelPasswordFind"><button class = "EandTbutton"><img src = "/resources/image/T.png" class = "EandTImageStyle"/>&nbsp;가입한 핸드폰 번호로 비밀번호 찾기</button></a>
							</div>
						</div>
					</div>
				</section>
