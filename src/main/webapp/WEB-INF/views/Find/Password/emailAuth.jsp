...
<body>
	<div align = "center">
		...
		<div align = "center" class = "emailAuthDivStyle"><br/><br/><br/>
			<form method = "post" name = "authenform" onSubmit = "return check();" onkeydown="return captureReturnKey(event)">
				<label class = "EmailAuthLabel"> 인증번호 7자리를 입력해 주세요. </label><br/><br/><br/>
				<input type = "text" name ="authnum" id = "authnum" style = "font-size:15px; padding:5px;"/><br/><br/><br/>
