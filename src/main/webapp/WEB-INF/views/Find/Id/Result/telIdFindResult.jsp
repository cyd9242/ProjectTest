	...
	<div id="wrapper">
		...
		<div id="main">
			...
			<section id="one">
				<div class="inner">
					<header>
						<c:if test="${vIds_Tel ne null}">
							<div align = "center" class = "telIdFindResultDivStyle">
								<table border = "1" cellpadding = "7" cellspacing = "0" class = "telIdFindResultTableStyle" align = "center">
									<c:forEach var = "list" varStatus = "vs" items = "${vIds_Tel}" begin = "0" end = "${vIds_Tel.size()}" step = "1">
											<tbody>
												<tr>
													<th style = "border-top-left-radius: 10px; border-bottom-left-radius: 10px;">아이디</th>
													<td align = "left" style = "border-right:none; width:150px;">
														<label class = "TelIdFindResultLabel"> <c:out value="${list.vId}" /></label>
													</td>
													<th>가입한 날짜</th>
													<td style = "border-top-right-radius: 10px; border-bottom-right-radius: 10px;">
														<label class = "TelIdFindResultLabel"><fmt:formatDate pattern="yyyy년MM월 dd일" value="${list.vDate}"/></label>
													</td>					
												</tr>
						...
						<c:if test="${empty vIds_Tel}">
							<div align = "center" class = "telIdFindResultDivStyle">
								<label class = "TelIdFindResultLabel1">회원가입을 먼저해 주세요.</label><br/>
