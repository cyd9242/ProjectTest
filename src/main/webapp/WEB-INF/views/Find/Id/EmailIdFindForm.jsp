...
<body class="is-preload" name = "top">
	...
	<div id="wrapper">
		...
		<section id="banner" class="style7">
			<div class="inner">
				<header class="major">
					<div align = "center">
						<h1 style = "color:white;">가입한 이메일로 아이디 찾기</h1>
					</div>
				</header>
			</div>
		</section>
									...
									<tbody>
										<tr>
											...
											<td colspan = "3" style = "padding :7px;">
												<form:input path = "vName" placeholder = " 이름" id = "vName" style = "position:relative; left:15px; border:none; background:transparent; width:85%; vertical-align: center;"/>
											</td>
										</tr>
										<tr>
											<th style = "background: none;"><br/><br/></th>
										</tr>
										...
										<tr>
											<th style = "padding: 7px;">이메일</th>
											<td colspan = "2">
												<form:input path = "vEmail" placeholder = " Email" id = "vEmail" style = "position:relative; left:15px; border:none; background:transparent; width:85%; vertical-align: center;" />
											</td>
											<td>
										...
										<tr>
											...
											<td colspan = "3" align = "right">
												<br/><input type = "text" readOnly = "readOnly" id = "checkRe" disabled = "" style = "border:none; width:95%; background: none; color:red; font-size:15px;"><br/>
											</td>
										</tr>
										
										<tr>
											<td colspan = "4" align = "center">
												<input type = "submit" value = "아이디 찾기" class = "EmaillIdFindbutton"/>
											</td>
										</tr>
									</tbody>
								</form:form>
	...
	<script src='<c:url value="/resources/js/EmailIdFindCheck.js"/>'></script>
	<script src='<c:url value="/resources/js/IdFindEmail.js"/>'></script>
	<script src='<c:url value="/resources/js/notHiddenTop.js"/>'></script>
</body>
</html>